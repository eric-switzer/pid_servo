...
#define SE_10_00V  (0x9)           // Single Ended +/- 10.0 V
...
int usbAInScan_USB1208FS_SE(int fd[], __u8 lowchannel, __u8 highchannel, __u32 count,
		    float *frequency, __u8 options, __s16 sdata[]);
void usbALoadQueue_USB1208FS(int fd, __u8 num, __u8 chan[], __u8 gains[]);
